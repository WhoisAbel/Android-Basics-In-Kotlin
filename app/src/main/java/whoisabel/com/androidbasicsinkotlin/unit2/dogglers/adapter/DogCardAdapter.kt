package whoisabel.com.androidbasicsinkotlin.unit2.dogglers.adapter
...
import whoisabel.com.androidbasicsinkotlin.unit2.dogglers.data.DataSource
...
class DogCardAdapter(
    ...
    private val dataList = DataSource.dogs
        ...
        val adapterLayout = when (layout) {
            Layout.GRID -> {
                LayoutInflater.from(parent.context)
                    .inflate(R.layout.item_grid_list, parent, false)
            }
            else -> {
                LayoutInflater.from(parent.context)
                    .inflate(R.layout.item_vertical_horizontal_list, parent, false)
            }
        }
    ...
    override fun getItemCount(): Int =
        dataList.size // TODO: return the size of the data set instead of 0
